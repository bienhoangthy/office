...
class my_lib
{
    ...
    public static function cms_site()
    {
        # code...
        $url = self::base_url().'cms/';
        return $url;
    }
    public static function template_cms()
    {
        # code...
        $template = 'default';
        return $template;
    }
    public static function template_site()
    {
        # code...
        $template = 'default';
        return $template;
    ...
    public static function cms_img()
    {
        # code...
        $url = self::base_url().'application/views/cms/template/'.self::template_cms().'/images/';
        return $url;
    }
    public static function cms_css()
    {
        # code...
        $url = self::base_url().'application/views/cms/template/'.self::template_cms().'/css/';
        return $url;
    }
    public static function cms_js()
    {
        # code...
        $url = self::base_url().'application/views/cms/template/'.self::template_cms().'/js/';
        return $url;
    }
    public static function cms_fileupload()
    {
        # code...
        $url = self::base_url().'application/libraries/filemanager/';
        return $url;
    }
    ...
    */
    ...
    public static function printArr($array)
    {
     ...
     /**begin kiem tra mang*/    
      ...
      /**begin ham cat chuoi*/    
    public static function substring($data,$limit){
    ...
    public static function location_time($url){
        if($url){
