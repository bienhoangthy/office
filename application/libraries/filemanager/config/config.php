...
if (isset($_SESSION["id_user_sc"]) && $_SESSION["id_user_sc"]) {
	$base_url ="";  // DON'T TOUCH (base url (only domain) of site (without final /)).
	$upload_dir = '/media/upload/file/'; // path from base_url to base of upload folder (with start and final /)
	$current_path = '../../../media/upload/file/'; // relative path from filemanager folder to upload folder (with final /)
	$thumbs_base_path = '../../../media/upload/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
	if(isset($_SESSION["f_user_folder"]) && $_SESSION["f_user_folder"])
	{
		$upload_dir.= 'nhanvien/'.$_SESSION["f_user_folder"].'/';
		$current_path.= 'nhanvien/'.$_SESSION["f_user_folder"].'/';
		$thumbs_base_path.= 'nhanvien/'.$_SESSION["f_user_folder"].'/';
	}
	if(isset($_SESSION["contract"]) && $_SESSION["contract"])
	{
		$upload_dir = '/media/customer/'.$_SESSION["contract"].'/';
		$current_path = '../../../media/customer/'.$_SESSION["contract"].'/';
		$thumbs_base_path = '../../../media/customer/thumbs/'.$_SESSION["contract"].'/';
