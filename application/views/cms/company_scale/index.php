                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-toolbar-wrapper pl0 pt5 pb5">
                                ...
                                <div class="panel-toolbar text-right">
                                    ...
                                    <a href="<?= my_lib::cms_site()?>company_scale/add/" class="btn btn-sm btn-primary"><i class="ico-plus"></i> Add</a>
                                </div>
                            </div>
                            <!--/ panel toolbar wrapper -->
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($list) && $list){
                                            ...
                                            foreach ($list as $key => $value) {
                                                ...
                                                $value["scale_status"] = $value["scale_status"] == 1 ? '<small class="btn btn-primary btn-xs"><i class=" ico-eye"></i> Active</small>':'<small class="btn btn-danger btn-xs"><i class=" ico-eye-blocked"></i> Block</small>';                                            
                                                $link_update = my_lib::cms_site().'company_scale/edit/'.$value["id"].'/?redirect='.base64_encode(current_url());
                                                $link_delete = my_lib::cms_site().'company_scale/delete/'.$value["id"].'/?redirect='.base64_encode(current_url());;
                                                echo '<tr>';
                                                    echo '<td>';
                                                    ...
                                                    echo '<td><a>'.$value["scale_name"].'</a></td>';                                                
                                                    echo '<td class="text-center">'.$value["scale_status"].'</td>';
