            ...
            <div class="container-fluid">
                ...
                <div class="page-header page-header-block">
                    <div class="page-header-section">
                        <h4 class="title semibold">Cập nhật</h4>
                    </div>
                    <div class="page-header-section">
                        <!-- Toolbar -->
                        <div class="toolbar">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="panel-footer">
                                    <div class="form-group no-border">
                                        ...
                                        <div class="col-sm-9 text-right">
                                            ...
                                            <a class="btn btn-success" href="<?= my_lib::cms_site()?>news/add/"><i class="ico-plus"></i>  Add</a>
                                            <a class="btn btn-info" href="<?= my_lib::cms_site()?>news/"><i class="ico-list"></i>  List</a>
                                        </div>
                                    </div> 
                                </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" class="form-control" id="hdnews_event" name="hdnews_event" value="<?= $formData['hdnews_event']?>" placeholder="Nhập từ khóa cần tìm...">
                                    </div>
                                </div>                                                          
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">                                        
                                        <textarea class="form-control" id="news_summary" name="news_summary" ><?= $formData['news_summary']?></textarea>
                                    </div>
                                </div>                               
                                <div class="form-group">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-sm-9">                                                                 
                                        ...
                                        <div class="row">
                                            <?php
                                            if($formData['news_picture'])
                                            {
                                            echo '<div class="show_proccess " style="display:block">';
                                                echo '<div class="col-lg-4 show_img_16_9"><img class="tmp_del_thumb169" src="'.str_replace("-thumb43", "-thumb169",$formData['news_picture']).'" /> <br />{16:9}</div>';
                                                echo '<div class="col-lg-4 show_img_4_3"><img class="tmp_del_thumb43" src="'.$formData['news_picture'].'" /> <br />{4:3}</div>';
                                                echo '<div class="col-lg-4 show_img_1_1"><img class="tmp_del_thumb11" src="'.str_replace("-thumb43", "-thumb11",$formData['news_picture']).'" /> <br />{1:1}</div>';
                                            echo '</div>';
                                            }
                                            ?>                                                                                             
                                        </div>
