                        ...
                        <form class="panel panel-default form-horizontal form-bordered"  method="post">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label text-danger">Địa chỉ</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" required="required" id="company_address" name="company_address" value="<?= $formData['company_address']?>" />
                                            </div>
                                        </div> 
                                    </div> 
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label text-danger">Số điện thoại</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" required="required" id="phone" name="phone" value="<?= $formData['phone']?>" />
                                            </div>
                                        </div> 
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control business_type" name="business_type" placeholder="Select a person...">
                                                <?= $business_type;?>
                                                </select>                                                 
                                            </div>
                                        </div> 
