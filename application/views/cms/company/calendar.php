    ...
    <div class="container-fluid">        
        <div class="page-header page-header-block">
            ...
            <div class="page-header-section text-right">
                <a href="<?= my_lib::cms_site()?>calendar/add/?redirect=<?= base64_encode(current_url())?>" class="btn btn-primary" ><span class="ico-plus-circle2"></span> Add Event</a>
            </div>
        </div>        
        
        <div class="row">
            <div class="col-lg-12" style="margin-bottom:10px;">
                <select class="form-control fuserid" id="selectize-select" name="fuserid">
                <?= $fuserid;?>
                </select>                   
            </div> 
...
$(function () {   
    /**begin chuyen trang*/ 
    $(".fuserid").bind("change",function(){
        id = $(this).val();
        window.location.href = configs.cms_site+'company/calendar/?fuserid='+id;
    })
    /**end chuyen trang*/ 
