            ...
            <div class="col-md-12">
                <div class="panel panel-teal">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-table22"></i></span> Danh sách thể hiện thông tin hợp đồng <span class="label label-danger"><?= $textFilter?></span></h3>
                        <!-- panel toolbar -->
                                ...
                                <tr>
                                    <th colspan="12">
                                        ...
                                        <div class="pull-left" style="margin-left:5px;">
                                            <?php if ($s_info['s_user_group'] == 1 || $s_info['s_user_group'] == 2 || $s_info['s_user_group'] == 5): ?>
                                                ...
                                                <a href="<?= my_lib::cms_site()?>infoservice/exportExcel/?and=<?= $condition?>" class="btn btn-sm btn-teal"><i class="ico-file-excel"></i> Xuất file Excel</a>
                                                <?php if ($flagDuration == 1): ?>
                                                    <a href="<?= my_lib::cms_site()?>infoservice/setDuration" class="btn btn-sm btn-primary"><i class="ico-spinner8"></i> Cập nhật thời hạn</a>
                                                <?php else: ?>
                                                    <button class="btn btn-sm btn-default" disabled="disabled"><i class="ico-check"></i> Đã cập nhật thời hạn</button>
                                                <?php endif ?>
                                            <?php endif ?>                                         
                                ...
                                <?php if (!empty($list)): ?>
                                    ...
                                    <?php foreach ($list as $key => $value): ?>
                                        <?php 
                                            ...
                                            $package_service = $this->mservice->getData('service_name,service_price','id = '.$value["service_package"]);
                                            ...
                                            $duration = $this->minfoservice->listDuration($value["service_duration"]);
                                            $restday="";
                                            if ($value["service_duration"] != 3) {
                                                $date_now = date('Y-m-d');
                                         ...
                                         <tr>
                                             ...
                                             <td class="text-center"><span class="label label-<?= $duration['color']?>"><?= $duration['name'].$restday?></span></td>
