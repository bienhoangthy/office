                ...
                <form class="panel panel-default form-horizontal form-bordered" enctype="multipart/form-data"  method="post">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="form-group no-border">
                                <div class="col-sm-12 text-right">
                                    <?php if (!empty($formData['company_id'])): ?>
                                        ...
                                        <a class="btn btn-inverse pull-left" href="<?= $link_company?>"><i class="ico-backward2"></i>  Bảng làm việc</a>
                                    <?php endif ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" readonly="readonly" class="form-control" name="service_domain" id="service_domain"  required="required"  value="<?= $formData['service_domain']?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" readonly="readonly"  class="form-control" name="service_userser" id="service_userser" value="<?= $formData['service_userser']?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Phí hợp đồng</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="service_price" id="service_price"  value="<?= $formData['service_price']?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Lần thanh toán</label>
                            <div class="col-sm-9">
                                <input type="number" min="1" max="3" class="form-control" name="service_pay" id="service_pay"  value="<?= $formData['service_pay']?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="panel-footer">
                            <div class="form-group no-border">
                                ...
                                <div class="col-sm-9 text-right">                                   
                                    <button type="submit" name="fsubmit-suspend" class="btn btn-primary"><i class="ico-save"></i> Khóa</button>
                                    <button type="submit" name="fsubmit-unsuspend" class="btn btn-primary"><i class="ico-save"></i> Mở khóa</button>
                                    <button type="submit" name="fsubmit" class="btn btn-primary"><i class="ico-save"></i> Save</button>                                        
                                </div>
                            </div> 
                        </div> 
...
$(document).ready(function(){
    ...
    $(".deletefile").click(function(){
        ...
        if (choice) {
            var filename = $(this).attr("idF");
            var idI = $(this).attr("idI");
            var idSer = <?= $formData['id']?>;
            var url = '<?= my_lib::cms_site()."infoservice/delFileAjax"?>';
            $.ajax({
                type: 'post',
                data: {"filename":filename, "idSer":idSer},
                cache: false,
                url: url,
                success: function(rs) {
                    if (rs == "ok") {$("#file"+idI).remove();}
                }
            });   
        }
    });
