                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="user_username" readonly="readonly"  name="user_username" value="<?= $formData['user_username']?>" required="required">
                                            </div>
                                        </div> 
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="user_push_id" name="user_push_id" value="<?= $formData['user_push_id']?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <?php if ($formData['user_file'] != ""): ?>
                                                <?php $link_file = my_lib::base_url().'media/user/'.$formData['user_file']; ?>
                                                <a href="<?= $link_file?>"><code><?= $formData['user_file']?></code></a>
                                            <?php endif ?>
