            ...
            <div class="container-fluid">
                ...
                <div class="page-header page-header-block">
                    <div class="page-header-section">
                        <h4 class="title semibold">List Config</h4>
                    </div>
                    <div class="page-header-section">
                        <!-- Toolbar -->
                        <div class="toolbar">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-toolbar-wrapper pl0 pt5 pb5">                               
                                <div class="panel-toolbar text-right">
                                    <div class="btn-group">
                                        <a href="<?= my_lib::cms_site()?>config/add/" class="btn btn-sm btn-primary"><i class="ico-plus"></i> Add</a>                                        
                                    </div>                                
                                </div>
                            </div>
                            <!--/ panel toolbar wrapper -->
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($list) && $list){
                                            ...
                                            foreach ($list as $key => $value) {
                                                # code...                                                
                                                $link_update = my_lib::cms_site().'config/edit/'.$value["id"].'/?redirect='.base64_encode(current_url());
                                                $link_delete = my_lib::cms_site().'config/delete/'.$value["id"].'/?redirect='.base64_encode(current_url());;
                                                echo '<tr>';                                                                                                   
                                                    echo '<td class="text-center">'.$value["id"].'</td>';
                                                    echo '<td>'.$value["config_note"].'</td>';                                                    
                                                    echo '<td><code>'.$value["config_name"].'</code></td>';
                                                    echo '<td>'.$value["config_value"].'</td>';                                                    
                                                    echo '<td>'.$value["config_create"].'</td>';
