                                ...
                                <div class="panel-footer">
                                    <div class="form-group no-border">
                                        ...
                                        <div class="col-sm-9 text-right">
                                            ...
                                            <a class="btn btn-success" href="<?= my_lib::cms_site()?>company_work/add/"><i class="ico-plus"></i>  Thêm mới</a>
                                            <a class="btn btn-info" href="<?= my_lib::cms_site()?>company_work/"><i class="ico-list"></i>  Dánh sách</a> 
                                        </div>
                                    </div> 
                                </div> 
