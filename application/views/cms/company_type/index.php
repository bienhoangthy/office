                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-toolbar-wrapper pl0 pt5 pb5">
                                ...
                                <div class="panel-toolbar text-right">
                                    ...
                                    <a href="<?= my_lib::cms_site()?>company_type/add/" class="btn btn-sm btn-primary"><i class="ico-plus"></i> Add</a>
                                </div>
                            </div>
                            <!--/ panel toolbar wrapper -->
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($list) && $list){
                                            ...
                                            foreach ($list as $key => $value) {
                                                ...
                                                $link_update = my_lib::cms_site().'company_type/edit/'.$value["id"].'/?redirect='.base64_encode(current_url());
                                                $link_delete = my_lib::cms_site().'company_type/delete/'.$value["id"].'/?redirect='.base64_encode(current_url());;
                                                echo '<tr>';
                                                    echo '<td>';
                                                    ...
                                                    echo '<td><a>'.$value["type_name"].'</a></td>';                                                
                                                    echo '<td class="text-center">'.$value["type_status"].'</td>';                                                    
