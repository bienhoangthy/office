...
$(function () {
    ...
    (function() {
        if($("#chart-bar").length !== 0) {
            ...
            var chart  = new flotDemo("#chart-bar", "server/flot77f0.html?type=bar"),
    ...
    (function() {
        if($("#chart-bar-stacked").length !== 0) {
            // Chart option/setting
            var chart  = new flotDemo("#chart-bar-stacked", "server/flot6cb4.html?type=barstacked"),
                option = {
                    series: {
                        stack: true,
                        bars: {
    ...
    (function() {
        if($("#chart-area").length !== 0) {
            // Chart option/setting
            var chart  = new flotDemo("#chart-area", "server/flot2961.html?type=area"),
                option = {
                    series: {
                        lines: {
                            show: true,
    ...
    (function() {
        if($("#chart-area-spline").length !== 0) {
            // Chart option/setting
            var chart  = new flotDemo("#chart-area-spline", "server/flotd6ef.html?type=areaspline"),
                option = {
                    series: {
                        lines: { show: false },
                        splines: {
    ...
    (function() {
        if($("#chart-line").length !== 0) {
            // Chart option/setting
            var chart  = new flotDemo("#chart-line", "server/flotf6c1.html?type=line"),
                option = {
                    series: {
                        lines: {
                            show: true,
    ...
    (function() {
        if($("#chart-line-spline").length !== 0) {
            // Chart option/setting
            var chart  = new flotDemo("#chart-line-spline", "server/flot17a0.html?type=linespline"),
                option = {
                    series: {
                        lines: { show: false },
                        splines: {
    ...
    (function() {
        if($("#chart-pie1").length !== 0) {
            // Chart option/setting
            var chart  = new flotDemo("#chart-pie1", "server/flotd2fd.html?type=pie"),
                option = {
                    series: {
                        pie: { 
                            show: true,
    ...
    (function() {
        if($("#chart-pie2").length !== 0) {
            // Chart option/setting
            var chart  = new flotDemo("#chart-pie2", "server/flotd2fd.html?type=pie"),
                option = {
                    series: {
                        pie: { 
                            show: true,
