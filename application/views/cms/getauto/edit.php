                        ...
                        <form class="panel panel-default form-horizontal form-bordered"  method="post">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">                                        
                                        <input type="text" name="field[news_name][extra]" value="<?= $formData['news_name_extra']?>" id="news_name_extra" class="form-control" placeholder="Lấy tên" required="required" >
                                    </div>  
                                    <div class="col-sm-4">                                        
                                        <input type="text" name="field[news_name][element_delete]" value="<?= $formData['news_name_delete']?>" id="news_name_element_delete" class="form-control" placeholder="Xóa không cần thiết">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">                                        
                                        <input type="text" name="field[news_detail][extra]" value="<?= $formData['news_detail_extra']?>" id="news_detail_extra" class="form-control" placeholder="Lấy chi tiết" required="required" >
                                    </div>  
                                    <div class="col-sm-4">                                        
                                        <input type="text" name="field[news_detail][element_delete]" value="<?= $formData['news_detail_delete']?>" id="news_detail_element_delete" class="form-control" placeholder="Xóa không cần thiết">
                                    </div>
                                </div> 
