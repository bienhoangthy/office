    ...
    <div class="container-fluid">                
        ...
        <div class="row">
            <div class="col-md-12">                        
                ...
                <input type="hidden" value="<?= $formData["id"]?>" id="hdID" />
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel-footer">
                            <div class="form-group no-border">
                                ...
                                <div class="col-sm-9 text-right">
                                    ...
                                    <a href="<?= my_lib::cms_site()?>group" class="btn btn-danger">Exit</a>
                                </div>
                            </div> 
                        </div> 
                        ...
                        <div class="panel-footer">
                            <div class="form-group no-border">
                                <label class="col-sm-3 control-label"></label>
                                <div class="col-sm-9 text-right">
                                    <button type="submit" name="fsubmit" class="btn btn-primary"><i class="icon-save"></i> Save</button>
                                    <a href="<?= my_lib::cms_site()?>group" class="btn btn-danger">Exit</a>
                                </div>
                            </div> 
                        </div>                                                          
