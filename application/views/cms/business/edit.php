                                ...
                                <div class="panel-footer">
                                    <div class="form-group no-border">
                                        ...
                                        <div class="col-sm-9 text-right">
                                            ...
                                            <a class="btn btn-success" href="<?= my_lib::cms_site()?>business/add/"><i class="ico-plus"></i>  Add</a>
                                            <a class="btn btn-info" href="<?= my_lib::cms_site()?>business/"><i class="ico-list"></i>  List</a>
                                        </div>
                                    </div> 
                                </div> 
