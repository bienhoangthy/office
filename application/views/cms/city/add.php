                        ...
                        <form class="panel panel-default form-horizontal form-bordered"  method="post">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="city_name" name="city_name" value="<?= $formData['city_name']?>" required="required">
                                    </div>
                                </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-6"><input type="text" class="form-control datepicker" placeholder="From" name="city_create" id="city_create" value="<?= $formData['city_create']?>"/></div>                                            
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <span class="radio custom-radio custom-radio-primary">  
                                            <input <?= $formData['city_status']==1?'checked':''?> type="radio" id="city_status1" name="city_status" value="1">  
                                            <label for="city_status1">&nbsp;&nbsp;Active</label>

                                            <input <?= $formData['city_status']==0?'checked':''?> type="radio" id="city_status0" name="city_status" value="0">  
                                            <label for="city_status0">&nbsp;&nbsp;Block</label>
                                        </span>                                        
                                    </div>
                                </div>
