                        ...
                        <form class="panel panel-default form-horizontal form-bordered"  method="post">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="translate_name" name="translate_name" value="<?= $formData['translate_name']?>" required="required" autocomplete="off">
                                    </div>
                                </div> 
                                    ...
                                    foreach ($translate_lang as $key => $value) {
                                        ...
                                        echo '<div class="form-group">';
                                            ...
                                            echo '<div class="col-sm-9">';
                                                echo '<input type="text" class="form-control" id="'.$value["language_alias"].'" name="'.$value["language_alias"].'" value="" required="required">';
                                            echo '</div>';
                                        echo '</div>';
                                    }
                                }
