                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-toolbar-wrapper pl0 pt5 pb5">
                                ...
                                <div class="panel-toolbar text-right">
                                    ...
                                    <a href="<?= my_lib::cms_site()?>company_sector/add/" class="btn btn-sm btn-primary"><i class="ico-plus"></i> Add</a>
                                </div>
                            </div>
                            <!--/ panel toolbar wrapper -->
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($list) && $list){
                                            ...
                                            foreach ($list as $key => $value) {
                                                $value["sector_status"] = $value["sector_status"] == 1 ? '<small class="btn btn-primary btn-xs"><i class=" ico-eye"></i> Active</small>':'<small class="btn btn-danger btn-xs"><i class=" ico-eye-blocked"></i> Block</small>';                                            
                                                $link_update = my_lib::cms_site().'company_sector/edit/'.$value["id"].'/?redirect='.base64_encode(current_url());
                                                $link_delete = my_lib::cms_site().'company_sector/delete/'.$value["id"].'/?redirect='.base64_encode(current_url());;
                                                echo '<tr>';
                                                    echo '<td>';
                                                    ...
                                                    echo '<td><a class="text-danger">'.$value["sector_name"].'</a></td>';                                                
                                                    echo '<td class="text-center">'.$value["sector_status"].'</td>';                                                    
                                                ...
                                                echo '</tr>';   
                                                /**begin cap 2*/                                             
                                                $and_C2 = 'sector_parent = '.$value["id"];
                                                $list_c2 = $this->mcompany_sector->getQuery($object="",$join="",$and_C2,$orderby,$limit="");
                                                if($list_c2)
                                                {
                                                    foreach ($list_c2 as $key_c2 => $value_c2) {
                                                        $value_c2["sector_status"] = $value_c2["sector_status"] == 1 ? '<small class="btn btn-primary btn-xs"><i class=" ico-eye"></i> Active</small>':'<small class="btn btn-danger btn-xs"><i class=" ico-eye-blocked"></i> Block</small>';                                            
                                                        $link_update_c2 = my_lib::cms_site().'company_sector/edit/'.$value_c2["id"].'/?redirect='.base64_encode(current_url());
                                                        $link_delete_c2 = my_lib::cms_site().'company_sector/delete/'.$value_c2["id"].'/?redirect='.base64_encode(current_url());;
                                                        echo '<tr>';
                                                            echo '<td>';
                                                                echo '<div class="checkbox custom-checkbox nm">';
                                                                    echo '<input type="checkbox" id="customcheckbox-one'.$i.'" value_c2="'.$value_c2["id"].'" data-toggle="selectrow" data-target="tr" data-contextual="stroke" name="checkid[]">';
                                                                    echo '<label for="customcheckbox-one'.$i.'"></label>';
                                                                echo '</div>';
                                                            echo '</td>';                                                

                                                            echo '<td class="text-center">'.$value_c2["id"].'</td>';                                                
                                                            echo '<td><a> &nbsp; &nbsp; » '.$value_c2["sector_name"].'</a></td>';                                                
                                                            echo '<td class="text-center">'.$value_c2["sector_status"].'</td>';                                                    
