    ...
    <div class="container-fluid">
        ...
        <div class="page-header page-header-block">
            <div class="page-header-section">
                <h4 class="title semibold">Danh sách thông tin liên hệ</h4>
            </div>
            <div class="page-header-section">
                <!-- Toolbar -->
                <div class="toolbar">
                             ...
                             <tr>
                                <th colspan="10">                                            
                                    ...
                                    <div class="pull-left" style="margin-left:5px;">                                                                                            
                                        <a href="<?= my_lib::cms_site()?>infocontact/add/" class="btn btn-sm btn-primary"><i class="ico-plus"></i> Thêm mới</a>                                          
                                    </div>
                                </th>
                            </tr>
                                <tr>
                                    ...
                                    <th>Tên công ty</th>                                                                           
                                    <th>Người liên hệ</th>                                                                           
                                    <th class="text-center" width="15%">Nhân xưng</th>                                                                           
                            ...
                            <tbody>
                                ...
                                if(isset($list) && $list){
                                    ...
                                    foreach ($list as $key => $value) {
                                        # code...   
                                        $myCompany = $this->mcompany->getData(array('company_name'),array("id"=>$value['company_id'])); 
                                        $tmpNamcall = $this->minfocontact->listNhanXung($value['contact_name_call']);
                                        $value['contact_name_call'] = $tmpNamcall['name'];
                                        $link_update = my_lib::cms_site().'infocontact/edit/'.$value["id"].'/?redirect='.base64_encode(current_url());
                                        $link_delete = my_lib::cms_site().'infocontact/delete/'.$value["id"].'/?redirect='.base64_encode(current_url());
