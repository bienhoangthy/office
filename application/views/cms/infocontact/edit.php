                        ...
                        <div class="panel-footer">
                            <div class="form-group no-border">
                                ...
                                <div class="col-sm-9 text-right">
                                    ...
                                    <?php if($type!="working") { ?>
                                    <a class="btn btn-success" href="<?= my_lib::cms_site()?>infocontact/add/"><i class="ico-plus"></i>  Thêm mới</a>
                                    <a class="btn btn-info" href="<?= my_lib::cms_site()?>infocontact/"><i class="ico-list"></i>  Danh sách</a>                                     
                                    <?php } ?>
                                </div>
                            </div> 
                        </div> 
                        ...
                        <div class="panel-footer">
                            <div class="form-group no-border">
                                ...
                                <div class="col-sm-9 text-right">                                   
                                    ...
                                    <?php if($type!="working") { ?>                           
                                    <a class="btn btn-success" href="<?= my_lib::cms_site()?>infocontact/add/"><i class="ico-plus"></i>  Thêm mới</a>
                                    <a class="btn btn-info" href="<?= my_lib::cms_site()?>infocontact/"><i class="ico-list"></i>  Dánh sách</a>     
                                    <?php } ?>                                                         
                                </div>
                            </div> 
                        </div> 
