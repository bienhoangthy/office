                                ...
                                <div class="panel-footer">
                                    <div class="form-group no-border">
                                        ...
                                        <div class="col-sm-9 text-right">
                                            ...
                                            <a class="btn btn-success" href="<?= my_lib::cms_site()?>company_rate/add/"><i class="ico-plus"></i>  Add</a>
                                            <a class="btn btn-info" href="<?= my_lib::cms_site()?>company_rate/"><i class="ico-list"></i>  List</a>
                                        </div>
                                    </div> 
                                </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control rate_parent" name="rate_parent" placeholder="Chọn nhóm.." required="required">
                                            <option <?= $formData['rate_parent'] == 1 ? 'selected' :'';?> value="1">Thành công</option>
                                            <option <?= $formData['rate_parent'] == 2 ? 'selected' :'';?> value="2">Chưa thành công</option>
                                        </select>
                                    </div>
                                </div>
