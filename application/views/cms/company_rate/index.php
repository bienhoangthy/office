                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-toolbar-wrapper pl0 pt5 pb5">
                                ...
                                <div class="panel-toolbar text-right">
                                    ...
                                    <a href="<?= my_lib::cms_site()?>company_rate/add/" class="btn btn-sm btn-primary"><i class="ico-plus"></i> Add</a>
                                </div>
                            </div>
                            <!--/ panel toolbar wrapper -->
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($list) && $list){
                                            ...
                                            foreach ($list as $key => $value) {
                                                $value["rate_status"] = $value["rate_status"] == 1 ? '<small class="btn btn-primary btn-xs"><i class=" ico-eye"></i> Active</small>':'<small class="btn btn-danger btn-xs"><i class=" ico-eye-blocked"></i> Block</small>';    
                                                $group_rate = $value['rate_parent'] == 1 ? '<span class="label label-success">Thành công</span>' : '<span class="label label-danger">Chưa thành công</span>';                                    
                                                $link_update = my_lib::cms_site().'company_rate/edit/'.$value["id"].'/?redirect='.base64_encode(current_url());
                                                $link_delete = my_lib::cms_site().'company_rate/delete/'.$value["id"].'/?redirect='.base64_encode(current_url());;
                                                echo '<tr>';
                                                    echo '<td>';
                                                    ...
                                                    echo '<td style="color:'.$value["rate_color"].'">'.$value["rate_name"].'</td>';    
                                                    echo '<td class="text-center">'.$group_rate.'</td>';                                            
                                                    echo '<td class="text-center">'.$value["rate_status"].'</td>';                                                    
