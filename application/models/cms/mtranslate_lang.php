<?php
	...
	*/
	class mtranslate_lang extends CI_Model
	{
	    ...
	    /**begin cap nhat*/
	    public function editLang($translate_id,$translate_lang,$data){
	        $this->db->where(array("translate_id"=>$translate_id,"translate_lang"=>$translate_lang));
	        $this->db->update($this->table,$data);
	        return true;
	    }
	    /**end cap nhat*/
	    ...
	    /**begin xoa*/
	    public function deleteLang($translate_id){
	        if(is_numeric($translate_id)){
	            $this->db->where('translate_id',$translate_id);
	        }elseif(is_array($translate_id)){
	            $this->db->where_in('translate_id',$translate_id);
	        }
	        return $this->db->delete($this->table);
	    }
	    /**end xoa*/
